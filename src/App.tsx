...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] text-[#1a1a1a] font-sans selection:bg-black selection:text-white flex flex-col items-center justify-center p-6">
      ...
      {/* Footer */}
      <footer className="fixed bottom-8 text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-medium">
        &copy; {new Date().getFullYear()} Monik Studio. All Rights Reserved.
      </footer>
    </div>
  );
}
